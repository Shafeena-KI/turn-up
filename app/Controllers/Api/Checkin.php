...
public function markAsIn()
{
    ...
    if ($entry_type == 4 && $partner_in) { // Couple changed to Stag (legacy block kept)
        ...
        // Update entry_type and partner
        $entry_type = $partner_in == 'male' ? 1 : ($partner_in == 'female' ? 2 : 3);
    }
